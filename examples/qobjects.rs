...
pub Test as QTest{
    ...
    properties:
        ...
        b: bool; read: get_b, write: set_b, notify: b_changed;
        list: QVariantList; read: get_list, write: set_list, notify: list_changed;
});

fn main() {
    let list = qvarlist![["John", [2, 2]], ["Ivan", [10, 0]], ["Mary", [0, 1]]];
    let mut qtest = QTest::new(Test, "name".into(), 5, 5_f32, 5_f64, true, list.into());
    let list = qvarlist![[26, [2, 2]]];
    qtest.testname(54, 55, 5_f32, 6_f64, true, list.into());
